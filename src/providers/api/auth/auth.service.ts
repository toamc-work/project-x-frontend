...
class AuthService {
   ...
   * @throws HttpException if the API call fails or returns an error.
   */
  async guardianSigninSessionVerifyOtp(dto: VerifyOtpDto) {
    try {
   ...
   * @throws HttpException if the API call fails or returns an error.
   */
  async studentSigninSessionVerifyOtp(dto: VerifyOtpDto) {
    try {
   ...
   * @throws HttpException if the API call fails or returns an error.
   */
  async guardianSignupStudentSessionVerifyOtp(dto: VerifyOtpDto) {
    try {
